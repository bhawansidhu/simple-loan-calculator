...
function loanDetails(){
    ...
    document.getElementById(`interestRateDetail`).innerHTML += `${monthlyIntRate.toFixed(2)}<br>`;
    document.getElementById(`numberofYearsDetail`).innerHTML += `${loanTerms}<br>`;
    document.getElementById(`monthlyPaymentsDetail`).innerHTML += `$ ${monthlyInstallment.toFixed(2)}<br>`;
